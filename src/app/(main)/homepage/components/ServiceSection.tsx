            ...
            <div className="flex justify-evenly items-center gap-2 p-5">
                <div className="flex flex-col items-center">
                    <div className="bg-[#000000] border-[#7D8184] border-10 p-2 flex flex-col items-center rounded-full w-20 h-20">
                        <Image src="/assets/images/icon/qr_code.svg" alt="service-icon-1" />
                    </div>
                ...
                <div className="flex flex-col items-center">
                    <div className="bg-[#000000] border-[#7D8184] border-10 p-2 flex flex-col items-center rounded-full w-20 h-20">
                        <Image src="/assets/images/icon/Icon-Customer service.svg" alt="service-icon-1" />
                    </div>
                ...
                <div className="flex flex-col items-center">
                    <div className="bg-[#000000] border-[#7D8184] border-10 p-2 flex flex-col items-center rounded-full w-20 h-20">
                        <Image src="/assets/images/icon/Icon-secure.svg" alt="service-icon-1" />
                    </div>
